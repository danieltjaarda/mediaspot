        ...
        <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-2 lg:gap-14">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              <Link
                href="#portfolio"
                className="btn-squeeze inline-flex h-12 items-center justify-center rounded-full border border-neutral-300 px-8 text-base font-semibold text-neutral-900 hover:bg-neutral-900/5"
              >
                Bekijk ons werk
              </Link>
            </div>
