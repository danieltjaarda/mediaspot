...
export default function ContactModal() {
  ...
  // Onderschep elke klik op een tel:-link en toon de pop-up in plaats daarvan
  useEffect(() => {
    function onClick(e: MouseEvent) {
      const target = e.target as HTMLElement | null;
      const link = target?.closest?.('a[href^="tel:"]');
      if (!link || link.closest("[data-contact-modal]")) return;
      e.preventDefault();
      e.stopPropagation();
      setOpen(true);
    }
    ...
    >
      ...
      >
        ...
        <p className="mt-2 text-sm leading-relaxed text-neutral-500">
          Bel ons direct, stuur een WhatsApp-bericht of vul het
          contactformulier in. We reageren meestal binnen een paar uur.
        </p>
