...
export const metadata: Metadata = {
  title: "Evenementen — Mediaspot",
  description:
    "Aftermovies en eventvideo's met impact: bedrijfsevenementen, festivals, feesten en jubilea. Cinematisch gefilmd en scherp gemonteerd.",
};
